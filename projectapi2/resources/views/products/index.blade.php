...
.card {
    ...
    vertical-align: top;
    position: relative;
    height: 300px; /* Tetapkan tinggi kartu */
...
<body>
    ...
    <h1>Daftar Produk Minuman Starbucks</h1>
    ...
    $('.slick-slider').slick({
        ...
        variableWidth: true, // Tambahkan opsi variableWidth
        centerMode: true, // Tambahkan opsi centerMode
    });
});
